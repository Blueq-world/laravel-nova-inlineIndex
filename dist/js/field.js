...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-InlineIndex', __webpack_require__(4));
  Vue.component('detail-InlineIndex', __webpack_require__(7));
  Vue.component('form-InlineIndex', __webpack_require__(10));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    submit: function submit() {
      ...
      return Nova.request().post('/inline-index/update/' + this.resourceName, {
        id: this.resourceId,
        attribute: this.field.attribute,
        value: this.value
      }).then(function () {
        _this.$toasted.show(_this.field.name + ' updated', {
          type: 'success'
        });
        _this.refreshTable();
      }, function (response) {
  ...
  computed: {
    ...
    fieldtType: function fieldtType() {
    ...
    listener: function listener() {
      ...
      var event = eventPara.split('.');
      var name = event[0];
      var modifier = event[1] ? this.capitalize(event[1]) : null;
      return _defineProperty({}, name, function (e) {
        if (_this2.valueWasNotChanged) return;
        if (modifier && modifier === e.key) _this2.submit();
        if (!modifier) _this2.submit();
      });
    },
